...
coke_list = glob('C:/Users/rmsdu/OneDrive/문서/GitHub/2023_OSSP/2023_OSSP_Data/Train/Coca/*.jpg')
print(len(coke_list))  # 212

fanta_list = glob('C:/Users/rmsdu/OneDrive/문서/GitHub/2023_OSSP/2023_OSSP_Data/Train/Fanta/*.jpg')
print(len(fanta_list))  # 212

letsbee_list = glob('C:/Users/rmsdu/OneDrive/문서/GitHub/2023_OSSP/2023_OSSP_Data/Train/Letsbee/*.jpg')
print(len(letsbee_list))  # 212

pocari_list = glob('C:/Users/rmsdu/OneDrive/문서/GitHub/2023_OSSP/2023_OSSP_Data/Train/Pocari/*.jpg')
print(len(pocari_list))  # 212

sprite_list = glob('C:/Users/rmsdu/OneDrive/문서/GitHub/2023_OSSP/2023_OSSP_Data/Train/Sprite/*.jpg')
print(len(sprite_list))  # 212

tejava_list = glob('C:/Users/rmsdu/OneDrive/문서/GitHub/2023_OSSP/2023_OSSP_Data/Train/Tejava/*.jpg')
print(len(tejava_list))  # 212

####################

name_list = [coke_list, fanta_list, letsbee_list, pocari_list, sprite_list, tejava_list]
name = ['coca', 'fanta', 'letsbee', 'pocari', 'sprite', 'tejava']
